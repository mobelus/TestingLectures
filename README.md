...
За 1 спринт мы
1.1 пишем ТЗ для части_1 
1.2 разрабатываем фичи для части_1 
1.3 тестируем фичи для части_1 
1.4 Показываем результат Спринта заказчику

и так по частям 

2 Часть = 2 Спринт
2.1 пишем ТЗ для части_2 
2.2 разрабатываем фичи для части_2 
2.3 тестируем фичи для части_2 
2.4 Показываем результат Спринта заказчику
