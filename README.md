...
- **Эквивалентное разделение** (один и тот же результат теста для одной эквивалентной группы параметров - что 0, что 1, что 2, что 15 - будет ребёнок)

Возрастные группы и покупка билетов : 
...
- **Таблица принятия решений** (Desicion Table) = Матрица принятия решений 

Пример таблицы для 2-ух факторной авторизации (возможные сценарии):
